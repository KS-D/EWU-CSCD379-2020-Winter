...
namespace SecretSanta.Data.Tests
{
    public static class SampleData
    {
        ...
        static public Gift CreateRingGift() => new Gift(RingTitle, RingUrl, RingDescription, CreateUserInigo());
        ...
        public static Gift CreateGiftArduino() =>
            new Gift(ArduinoTitle, ArduinoUrl, ArduinoDescription,  CreateUserButtercup());
